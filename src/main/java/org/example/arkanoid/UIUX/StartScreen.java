...
public class StartScreen {
     ...
     * @param onStartGame Hành động sẽ được thực thi khi nút "Start Game" được nhấn.
     * @param onExitGame Hành động sẽ được thực thi khi nút "Exit" được nhấn.
     * @return Một Pane đã được cấu hình cho màn hình bắt đầu.
     */
    public Pane createContent(Runnable onStartGame, Runnable onExitGame) {
        // Sử dụng VBox để dễ dàng căn giữa các thành phần theo chiều dọc
